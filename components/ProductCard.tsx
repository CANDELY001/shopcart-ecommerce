    ...
    <div className="text-sm border-[1px] rounded-md border-darkBlue/20 group bg-white">
      <div className="relative group overflow-hidden bg-shop_light_bg">
        ...
        {product?.status === "hot" && (
          <Link
            href={"/deal"}
            className="absolute top-2 left-2 z-10 border border-shop_orange/50 p-1 rounded-full group-hover:border-shop_orange group-hover:text-shop_dark_green hoverEffect"
          >
            <Flame
              size={18}
              fill="#fb6c08"
      ...
      <div className="p-3 flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-shop_ligher_text text-xs tracking-wide">
            5 Reviews
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <p
            className={`${product?.stock === 0 ? "text-red-600" : "text-shop_dark_green font-semibold"}`}
          >
